...
# Clear Config Log Panorama
echo "Clearing Config Logs...on Panorama"
curl -k "https://192.168.1.252/api/?type=op&cmd=<clear><log><config></config></log></clear>&key=$tempkeyPANO"
echo "Complete"
